    ...
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center py-8">
      <div className="w-full max-w-md animate-slide-up">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-content">Join VividCraft</h1>
          <p className="text-mist mt-1">Sell your art or discover amazing digital works</p>
        </div>
        ...
        <p className="text-center text-sm text-mist mt-6">
          ...
          <Link to="/login" className="text-brand-accent-deep font-medium hover:text-brand-accent transition-colors">
            Sign in
          </Link>
        </p>
      </div>
